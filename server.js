...
function metrics(x){const a=vals(x), price=a.at(-1), prev=a.at(-2), hi=Math.max(...a), s200=sma(a,200); return {symbol:x.meta.symbol,name:x.meta.longName||x.meta.shortName||x.meta.symbol,currency:x.meta.currency,price,change:price-prev,changePct:(price/prev-1)*100,rsi:rsi(a),sma200:s200,above200:s200?price>=s200:null,distance200:s200?(price/s200-1)*100:null,drawdown:(price/hi-1)*100,high2y:hi,asOf:x.meta.regularMarketTime?new Date(x.meta.regularMarketTime*1000).toISOString():null}}
